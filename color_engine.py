...
def clear_gpu_cmap_cache():
    """Clears all cached GPU colormap lookup tables to ensure clean re-allocation upon device reset."""
    global GPU_CMAP_LUT_CACHE
    GPU_CMAP_LUT_CACHE.clear()